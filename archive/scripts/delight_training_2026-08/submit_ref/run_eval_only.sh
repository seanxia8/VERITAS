...
# Upload the data
xrdcp -r root://ceph-node-j.etp.kit.edu://dwong/training_samples_h5/ER data/
xrdcp -r root://ceph-node-j.etp.kit.edu://dwong/training_samples_h5/NR data/
find data/ -name "*energy_10_*" -delete
# find data/ -name "*energy_20_*" -delete
# find data/ -name "*energy_50_*" -delete
# find data/ -name "*energy_100_*" -delete
# find data/ -name "*energy_200_*" -delete
...
python -m reconstruction.evaluation.test_evaluation
