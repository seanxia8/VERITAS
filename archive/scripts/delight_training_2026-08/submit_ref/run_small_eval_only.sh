...
# xrdcp -r root://ceph-node-j.etp.kit.edu://ssjostrom/training_small_no_quantise/ER data/
# xrdcp -r root://ceph-node-j.etp.kit.edu://ssjostrom/training_small_no_quantise/NR data/
