...
Run from the repo root:  python src/noise_module_lucid/docs/plot_pmt_frontend_v2_final.py
Writes src/noise_module_lucid/docs/pmt_frontend_v2_final.png.
"""
...
from noise_module_lucid import (FS_L, GROUP, PMT_CRATE_V2, PMT_FRONTEND_V2, PMT_PRIVATE, PMT_SHARED,  # noqa: E402
                                RMS_MV, kappa)
...
fig.text(0.01, 0.005, "Generated by src/noise_module_lucid/docs/plot_pmt_frontend_v2_final.py from the noise_module_lucid package with the patched noise_module "
